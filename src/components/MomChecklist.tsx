    ...
    <section id="checklist" className="scroll-mt-20 sm:scroll-mt-24 py-12 sm:py-16 bg-pharmacy-orange-subtle/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-8 sm:mb-10">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-black bg-pharmacy-orange text-white shadow-xs mb-2.5 sm:mb-3">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-pharmacy-charcoal tracking-tight leading-[1.35] sm:leading-[1.4] mb-2.5 sm:mb-3">
            قبل ما الجرس يرن 🔔
          </h2>

          {/* Description with comfortable body Arabic line-height */}
          <p className="text-sm sm:text-base text-pharmacy-muted font-medium max-w-xl mx-auto leading-[1.7] sm:leading-relaxed">
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <h3
                    className={`text-base sm:text-lg font-black leading-[1.4] break-words transition-colors ${
                      isChecked
                  ...
                  <p className="text-xs sm:text-sm text-pharmacy-muted leading-[1.65] font-medium mt-1.5 sm:mt-2">
                    {item.subtitle}
                  </p>
                  ...
                  <div className="mt-2.5 sm:mt-3">
                    <button
                      ...
                      className="inline-flex max-w-full items-center gap-2 text-[11px] sm:text-xs font-extrabold text-pharmacy-orange hover:text-pharmacy-orange-hover bg-pharmacy-orange-light px-3 py-1.5 rounded-xl transition-colors whitespace-normal leading-normal"
                    >
                ...
                {/* Custom Styled Checkbox - strictly flex-shrink-0 with clear separation from text */}
                <div
                  className={`w-7 h-7 sm:w-8 sm:h-8 rounded-2xl flex items-center justify-center flex-shrink-0 transition-all duration-200 mt-0.5 ms-2.5 sm:ms-3 ${
                    isChecked
